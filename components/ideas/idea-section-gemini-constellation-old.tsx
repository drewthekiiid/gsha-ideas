...
const GEMINI_QUIPS_CONSTELLATION = [
  "Your star is about to align with someone special...",
  "First group of five to form a new shape gets a supernova moment!",
  "The constellation will live on as generative digital artwork",
  "You lit up the sky by connecting the unconnected",
  "Find the Shooting Star—first to spot gets a limited-edition badge",
]
  ...
  const storyPanels = [
    {
      ...
      content:
        "Enter through swirling space dust and laser fog. Your steps trigger new stars overhead. Get your 3D-printed star token and claim your spot in the digital constellation.",
    },
    {
      title: "Building the Constellation",
      content: "AI matches you for 'collision' moments. When stars connect, constellation zaps appear overhead. Complete constellation missions and discover AR hidden stories in the sky.",
    },
    {
      title: "The Gemini Reveal",
      content:
        "Epic finale as the digital constellation fuses into a kinetic, swirling galaxy. Every attendee's star pulses in a cosmic storm of campaign highlights and AR meteors.",
    },
  ]
    ...
    >
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-around h-full w-full max-w-6xl mx-auto gap-8">
        ...
        <div className="lg:w-2/5 flex flex-col items-center lg:items-start text-center lg:text-left">
          <h2
            className={cn(
              "text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight mb-3 text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-sky-500 to-blue-600",
          ...
          <Card className="bg-black/60 border-indigo-500/30 p-3 text-xs shadow-lg w-full max-w-md">
            ...
            <p className="text-neutral-300 italic">
              "The network effect in real-time at #GSHA2025 constellation ✨. Found my next collaborator among the stars!
              #GSHAConstellation #FutureOfNetworking"
            </p>
          </Card>
        </div>
