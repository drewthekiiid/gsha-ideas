...
import { Zap, Users, Megaphone, Sparkles, Target, Music } from "lucide-react" // Icons
...
const CARNIVAL_GAMES = [
  { name: "Meme Roulette", icon: <Sparkles className="h-4 w-4" />, action: "Spin for chaos!" },
  { name: "Human Claw Machine", icon: <Target className="h-4 w-4" />, action: "Grab a marketer!" },
  { name: "Query Confession", icon: <Megaphone className="h-4 w-4" />, action: "Confess your search!" },
  { name: "Flash Mob Stage", icon: <Users className="h-4 w-4" />, action: "Join the chaos!" },
]
